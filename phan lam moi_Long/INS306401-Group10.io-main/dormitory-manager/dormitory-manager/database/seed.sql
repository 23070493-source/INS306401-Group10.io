...
INSERT INTO services (id, service_name, unit, unit_price, default_price, description, is_active, status) VALUES
(1, 'electricity', 'kWh', 3500.00, 3500.00, 'Electricity usage fee', TRUE, 'active'),
(2, 'water', 'm3', 10000.00, 10000.00, 'Water usage fee', TRUE, 'active'),
(3, 'internet', 'month', 50000.00, 50000.00, 'Monthly internet fee', TRUE, 'active'),
(4, 'cleaning', 'month', 30000.00, 30000.00, 'Monthly cleaning fee', TRUE, 'active'),
(5, 'air_conditioner', 'month', 100000.00, 100000.00, 'Air conditioner service fee', TRUE, 'active');
...
INSERT INTO payments (
    ...
    payment_method, payment_status, status, paid_at, payment_date,
    sender_bank, sender_account_name, transaction_reference, note,
    verified_by, verified_at, rejection_reason
) VALUES
(1, 2, 3, 'PAY-2026-001', 1517000.00, 'bank_transfer', 'success', 'success', '2026-06-10 09:20:00', '2026-06-10 09:20:00', 'Vietcombank', 'Le Ngoc Chi', 'BANK-TXN-001', 'Full payment received', 3, '2026-06-10 10:00:00', NULL),
(2, 3, 4, 'PAY-2026-002', 500000.00, 'cash', 'success', 'success', '2026-06-11 14:30:00', '2026-06-11 14:30:00', 'Cash desk', 'Pham Thuy Dung', 'CASH-002', 'Partial payment', 2, '2026-06-11 15:00:00', NULL),
(3, 5, 8, 'PAY-2026-003', 2300000.00, 'online', 'success', 'success', '2026-06-09 20:15:00', '2026-06-09 20:15:00', 'Momo', 'Bui Khanh Linh', 'ONLINE-003', 'Full online payment', 3, '2026-06-10 08:15:00', NULL),
(4, 1, 2, 'PAY-2026-004', 300000.00, 'online', 'pending', 'pending', NULL, '2026-06-12 09:10:00', 'Techcombank', 'Tran Gia Binh', 'ONLINE-PENDING-004', 'Pending payment not counted', NULL, NULL, NULL);
...
INSERT INTO maintenance_requests (
    ...
    completed_at, manager_note, processed_by, processed_at, resolution_note
) VALUES
(1, 1, 2, 'Broken light', 'The ceiling light near the door is not working.', 'Broken light', 'The ceiling light near the door is not working.', 'electricity', 'medium', '2026-06-05 08:30:00', 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 6, 3, 'Water leakage', 'There is a small water leakage near the bathroom sink.', 'Water leakage', 'There is a small water leakage near the bathroom sink.', 'water', 'high', '2026-06-03 10:15:00', 'in_progress', 3, 3, '2026-06-04 09:00:00', NULL, 'Technician assigned', 3, '2026-06-04 09:00:00', 'Technician assigned'),
(3, 3, 4, 'Air conditioner noise', 'The air conditioner makes loud noise at night.', 'Air conditioner noise', 'The air conditioner makes loud noise at night.', 'electricity', 'medium', '2026-05-28 21:00:00', 'completed', 2, 2, '2026-05-30 11:00:00', '2026-05-30 11:00:00', 'AC fan cleaned', 2, '2026-05-30 11:00:00', 'AC fan cleaned'),
(4, 11, 7, 'Door lock issue', 'Room door lock is difficult to open.', 'Door lock issue', 'Room door lock is difficult to open.', 'furniture', 'medium', '2026-06-07 07:45:00', 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
